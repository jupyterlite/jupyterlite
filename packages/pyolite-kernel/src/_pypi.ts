...
export * as pipliteWheelUrl from '!!file-loader?name=pypi/[name].[ext]&context=.!../pypi/piplite-0.1.0b9-py3-none-any.whl';
export * as pyoliteWheelUrl from '!!file-loader?name=pypi/[name].[ext]&context=.!../pypi/pyolite-0.1.0b9-py3-none-any.whl';
...
export const PIPLITE_WHEEL = 'piplite-0.1.0b9-py3-none-any.whl';
